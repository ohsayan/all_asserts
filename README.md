# all_asserts [![Build Status](https://travis-ci.org/sntdevco/all_asserts.svg?branch=master)](https://travis-ci.org/sntdevco/all_asserts) ![Crates.io](https://img.shields.io/crates/v/all_asserts.svg?style=flat-square)
